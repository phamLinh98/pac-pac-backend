...
export const canAccessChat = async (chatId, userId) => (await run(chatModel.canAccessChat(chatId, userId)))[0]?.can_access === true;
export const sendImageMessage = async (chatId, userId, mediaKey, caption) => (await run(chatModel.sendImageMessage(chatId, userId, mediaKey, caption)))[0];
